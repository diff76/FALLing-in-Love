...
const preview: PassLookup = {
  ...
  party_size: 2, guest_count: 1, seat_label: "채플 A블록 1–2", transport: "shuttle", outbound_label: "12:00", return_label: null,
  ...
  return (
    <main className="passPage">
      ...
      <div className="passHead">
        ...
        <h1>{issued ? "신청이 완료되었습니다" : "Matinée Pass"}</h1>
      ...
      <article className="ticket" aria-label="Matinée Pass">
        ...
        <div className="ticketBody">
          <div>
            ...
            <p className="party">{pass.kind === "guest_self" ? `${pass.inviter_name ?? ""} 님의 초대` : pass.district_label ?? ""}{pass.guest_count > 0 ? ` · 함께 오시는 분 ${pass.guest_count}명` : " · 혼자 오십니다"}</p>
          </div>
          <dl className="ticketGrid">
            <div><dt>SEAT</dt><dd>{pass.seat_label ?? "현장 안내"}</dd></div>
